		...
		if(acymailing_level(1)){
			...
			if(ACYMAILING_J16){
				...
				if(!in_array(strtolower('seblod-directreg'), $JNotifications)){
					...
					$data[] = "('{trans:COM_CCK_EMAIL_ACCOUNT_DETAILS|param1|param2}', '".$bodyNotif."', '', 0, 'joomlanotification', 0, 'seblod-directreg', 1, ".$conftemplate.",NULL)";
				}
				if(!in_array(strtolower('seblod-directregnopwd'), $JNotifications)){
					...
					$data[] = "('{trans:COM_CCK_EMAIL_ACCOUNT_DETAILS|param1|param2}', '".$bodyNotif."', '', 0, 'joomlanotification', 0, 'seblod-directregnopwd', 1, ".$conftemplate.",NULL)";
				}
				if(!in_array(strtolower('seblod-notifadmin'), $JNotifications)){
					...
					$data[] = "('{trans:ACY_DEFAULT_NOTIF_SUBJECT}', '".$bodyNotif."', '', 0, 'joomlanotification', 0, 'seblod-notifadmin', 1, ".$conftemplate.",NULL)";
				}
				if(!in_array(strtolower('seblod-ownactivreg'), $JNotifications)){
					...
					$data[] = "('{trans:COM_CCK_EMAIL_ACCOUNT_DETAILS|param1|param2}', '".$bodyNotif."', '', 0, 'joomlanotification', 0, 'seblod-ownactivreg', 1, ".$conftemplate.",NULL)";
				}
				if(!in_array(strtolower('seblod-ownactivregnopwd'), $JNotifications)){
					...
					$data[] = "('{trans:COM_CCK_EMAIL_ACCOUNT_DETAILS|param1|param2}', '".$bodyNotif."', '', 0, 'joomlanotification', 0, 'seblod-ownactivregnopwd', 1, ".$conftemplate.",NULL)";
				}
				if(!in_array(strtolower('seblod-adminactivreg'), $JNotifications)){
					...
					$data[] = "('{trans:COM_CCK_EMAIL_ACCOUNT_DETAILS|param1|param2}', '".$bodyNotif."', '', 0, 'joomlanotification', 0, 'seblod-adminactivreg', 1, ".$conftemplate.",NULL)";
				}
				if(!in_array(strtolower('seblod-adminactivregnopwd'), $JNotifications)){
					...
					$data[] = "('{trans:COM_CCK_EMAIL_ACCOUNT_DETAILS|param1|param2}', '".$bodyNotif."', '', 0, 'joomlanotification', 0, 'seblod-adminactivregnopwd', 1, ".$conftemplate.",NULL)";
				}
			}else{
				if(!in_array(strtolower('joomla-directReg'), $JNotifications)){
